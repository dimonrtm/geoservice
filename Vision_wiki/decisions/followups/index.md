...
| FU-2026-05-31-001 | open     | Product discovery     | [[../../concepts/about_project]], [[../../chats/2026-05-31-initial-discover]], [[../../chats/2026-05-31-phase-f1-why-now]], [[../../chats/2026-06-02-phase-f2-users-and-pain]]             | Ф1-Ф2 завершены на уровне research-гипотез. Пройти Ф3: уточнить альтернативы и контекст использования для `Utility GIS editor`; затем проверить точный тип продукта.                                          |
...
| FU-2026-06-02-001 | open     | Product validation    | [[../../entities/personas/utility_gis_editor]], [[../../concepts/jtbd]], [[../../chats/2026-06-02-phase-f2-users-and-pain]]                                      | Для `Utility GIS editor` подготовить synthetic utility dataset и проверить topology, `attribute vs attribute`, `geometry/association`, `edit after reconcile`; при возможности найти реальный рабочий пример. |
