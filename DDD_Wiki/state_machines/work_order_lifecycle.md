...
```text
workspace_loaded -> geometry_diff_persisted -> basic_draft_validated -> submit_for_review -> draft_package -> ready_for_review -> under_review -> approved | returned | escalated -> can_post | blocked_post | stale -> simulated_posted
```
