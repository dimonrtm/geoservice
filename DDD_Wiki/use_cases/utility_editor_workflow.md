...
4. Сохранить full resulting geometry с `CommandId`, если hard invariants выполнены.
5. Получить `updatedFeature`, новый token, `operation`, `hasPersistedChangeSet` и `basicValidation`.
