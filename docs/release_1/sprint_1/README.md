...
Папка содержит актуальные материалы нового Спринта 1 Utility Workflow.

## Актуальные Документы

- [Календарный план](2026-06-12-sprint-1-utility-workflow-calendar-design.md)
- [Сценарий приемки Дня 1](2026-06-12-sprint-1-day-1-acceptance-design.md)
...
`legacy-generic-plan/` содержит старые планы прежнего generic GIS scope. Они
сохранены для истории и не определяют текущий Спринт 1 Utility Workflow.
