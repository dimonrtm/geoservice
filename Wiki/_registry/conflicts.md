...
| [[Wiki/conflicts/2026-06-27-review-post-before-edit-persistence]] | Sprint planning после открытия workspace | resolved | Сначала persisted feature update + edit-save-readback + draft validation flags; review/post layers откладываются | `RAW_inputs/meetings/increment_after_open_workspace.md` |
