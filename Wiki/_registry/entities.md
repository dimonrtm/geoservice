...
| [[Wiki/entities/edit_version]] | `id`, `workOrderId`, `baseNetworkRevision` | [[DDD_Wiki/aggregates/edit_version]] | high | `Code_wiki/архитектура/data_model.md`; `RAW_inputs/meetings/persisted_edit_slice_for_edit_version.md` |
