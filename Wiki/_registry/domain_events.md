...
| [[Wiki/domain_events/edit_version_change_set_persisted]] | [[DDD_Wiki/aggregates/edit_version]] | Readback diff и basic draft validation могут опереться на persisted geometry change set | high | `RAW_inputs/meetings/persisted_edit_slice_EditVersion.md` |
