...
| [[Wiki/domain_events/edit_version_change_set_persisted]] | [[DDD_Wiki/aggregates/edit_version]] | Readback и basic draft validation могут опереться на persisted geometry change set; event эмитится при первом переходе `unchanged -> updated` | high | `RAW_inputs/meetings/persisted_edit_slice_EditVersion.md`; `RAW_inputs/meetings/persisted_edit_slice_for_edit_version.md`; `RAW_inputs/meetings/first_save_edit_version.md` |
