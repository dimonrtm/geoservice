...
| [[Wiki/commands/submit_for_review]] | [[Wiki/actors/editor]] | [[Wiki/entities/edit_version]] | `ReviewPackage` в `ready_for_review` / `under_review` path | medium | `RAW_inputs/meetings/ic_review_package_and_simulated_post.md` |
