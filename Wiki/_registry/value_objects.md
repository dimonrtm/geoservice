...
| [[Wiki/value_objects/command_id]] | одинаковый id равен одной команде только при совпадении feature, базового состояния, типа правки, вершины и канонического результата | [[Wiki/commands/update_edit_version_feature_geometry]] | high | `RAW_inputs/meetings/first_save_for_edit_version.md`; `RAW_inputs/meetings/tolerance_rules.md` |
