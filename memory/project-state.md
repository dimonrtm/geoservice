...
- Последний `/ingest`: 2026-06-20, `RAW_inputs/documents/UtilityGisEditorRole.md` обработан как role research source; уточнены реальная практика `Utility GIS editor` как owner/editor of authoritative utility network changes, ArcGIS и QGIS/PostGIS/QField/GISwater stacks, field sync, topology QA, training и KPI.
